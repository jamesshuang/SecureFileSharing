...
public class DHIdentity {
  private KeyAgreement kAgree;
  private byte[] sharedSecret;

  public static final String CIPHER_ALG = "AES/CTR/PKCS5Padding";

  // DH Group 15 prime (see RFC 3526)
  private static final byte[] primeBytes = {
  	...
  	(byte)0x8A, (byte)0xAA, (byte)0xC4, (byte)0x2D,
  	(byte)0xAD, (byte)0x33, (byte)0x17, (byte)0x0D,
  	(byte)0x04, (byte)0x50, (byte)0x7A, (byte)0x33,
  	(byte)0xA8, (byte)0x55, (byte)0x21, (byte)0xAB,
  	(byte)0xDF, (byte)0x1C, (byte)0xBA, (byte)0x64,
  	(byte)0xEC, (byte)0xFB, (byte)0x85, (byte)0x04,
  	(byte)0x58, (byte)0xDB, (byte)0xEF, (byte)0x0A,
  	(byte)0x8A, (byte)0xEA, (byte)0x71, (byte)0x57,
  	(byte)0x5D, (byte)0x06, (byte)0x0C, (byte)0x7D,
  	(byte)0xB3, (byte)0x97, (byte)0x0F, (byte)0x85,
  	(byte)0xA6, (byte)0xE1, (byte)0xE4, (byte)0xC7,
  	(byte)0xAB, (byte)0xF5, (byte)0xAE, (byte)0x8C,
  	(byte)0xDB, (byte)0x09, (byte)0x33, (byte)0xD7,
  	(byte)0x1E, (byte)0x8C, (byte)0x94, (byte)0xE0,
  	(byte)0x4A, (byte)0x25, (byte)0x61, (byte)0x9D,
  	(byte)0xCE, (byte)0xE3, (byte)0xD2, (byte)0x26,
  	(byte)0x1A, (byte)0xD2, (byte)0xEE, (byte)0x6B,
  	(byte)0xF1, (byte)0x2F, (byte)0xFA, (byte)0x06,
  	(byte)0xD9, (byte)0x8A, (byte)0x08, (byte)0x64,
  	(byte)0xD8, (byte)0x76, (byte)0x02, (byte)0x73,
  	(byte)0x3E, (byte)0xC8, (byte)0x6A, (byte)0x64,
  	(byte)0x52, (byte)0x1F, (byte)0x2B, (byte)0x18,
  	(byte)0x17, (byte)0x7B, (byte)0x20, (byte)0x0C,
  	(byte)0xBB, (byte)0xE1, (byte)0x17, (byte)0x57,
  	(byte)0x7A, (byte)0x61, (byte)0x5D, (byte)0x6C,
  	(byte)0x77, (byte)0x09, (byte)0x88, (byte)0xC0,
  	(byte)0xBA, (byte)0xD9, (byte)0x46, (byte)0xE2,
  	(byte)0x08, (byte)0xE2, (byte)0x4F, (byte)0xA0,
  	(byte)0x74, (byte)0xE5, (byte)0xAB, (byte)0x31,
  	(byte)0x43, (byte)0xDB, (byte)0x5B, (byte)0xFC,
  	(byte)0xE0, (byte)0xFD, (byte)0x10, (byte)0x8E,
  	(byte)0x4B, (byte)0x82, (byte)0xD1, (byte)0x20,
  	(byte)0xA9, (byte)0x3A, (byte)0xD2, (byte)0xCA,
  	(byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0xFF,
  	(byte)0xFF, (byte)0xFF, (byte)0xFF, (byte)0xFF
  };
  
  private static final BigInteger modulus = new BigInteger(1, primeBytes);
  ...
  public byte[] send() throws Exception {
    DHParameterSpec gp = new DHParameterSpec(modulus, base);
    KeyPairGenerator keyPairGen = KeyPairGenerator.getInstance("DH", bc);
    keyPairGen.initialize(gp);
    KeyPair pair = keyPairGen.generateKeyPair();
    kAgree = KeyAgreement.getInstance("DH", bc);
    kAgree.init(pair.getPrivate());
  
    return pair.getPublic().getEncoded();
  }
  
  public byte[] receive(byte[] encodedBytes) throws Exception {
    KeyFactory keyFact = KeyFactory.getInstance("DH", bc);
    X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(encodedBytes);
    PublicKey receivedPublic = keyFact.generatePublic(x509KeySpec);
    DHParameterSpec sharedPG = ((DHPublicKey)receivedPublic).getParams();

    KeyPairGenerator gen = KeyPairGenerator.getInstance("DH", bc);
    gen.initialize(sharedPG);
  ...
  public SecretKey generateSharedSecret(byte[] encodedBytes) throws Exception {
    KeyFactory keyFact = KeyFactory.getInstance("DH", bc);
    X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(encodedBytes);
    PublicKey publicKey = keyFact.generatePublic(x509KeySpec);
    kAgree.doPhase(publicKey, true);
    SecretKey sharedSecret = kAgree.generateSecret("AES");
    return sharedSecret;
  }
