...
public interface FileClientInterface
{
	 ...
	 * @param keychain   The keychain to use for encrypting the file
     *
     * @return true on success, false on failure
     *
     */
    public boolean upload(final String sourceFile, final String destFile, final String group, final UserToken token, final GroupKeychain keychain);
     ...
     * @param token      The token of the user uploading the file
	 * @param keychain   The user keychain to use for decrypting the file
     *
     * @return true on success, false on failure
     *
     */
    public boolean download(final String sourceFile, final String destFile, final UserToken token, final Map<String, GroupKeychain> userKeychain);
